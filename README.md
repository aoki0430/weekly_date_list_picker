...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/weekly_date_list_picker
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/weekly_date_list_picker_test
```
